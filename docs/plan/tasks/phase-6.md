...
state. Lane key and standing constraints as in `phase-1.md`. Architecture
contracts: `../architecture.md` §Frontend integration (TauriCoreClient,
PlaybackEngine trait, WebKitGTK mitigations).

### T6.1 · grok · Tauri shell + TauriCoreClient
...
### T6.2 · codex · native playback engine
...
### T6.4 · grok · packaging + platform integration
...
(T6.2) is the only codex-tagged task — it owns thread-safety judgment.
